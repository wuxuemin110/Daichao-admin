    ...
    <div class="site-sidebar__inner">
      <el-menu
       ...
       <!-- <el-menu-item index="home" @click="$router.push({ name: 'home' })">
        ...
        <el-menu-item index="home" @click="$router.push({ name: 'banner' })">
          <icon-svg name="shouye" class="site-sidebar__menu-icon"></icon-svg>
          <span slot="title">banner</span>
        </el-menu-item>
        <el-menu-item index="home" @click="$router.push({ name: 'versionControl' })">
          <icon-svg name="shouye" class="site-sidebar__menu-icon"></icon-svg>
          <span slot="title">版本控制</span>
        </el-menu-item>
        <el-menu-item index="home" @click="$router.push({ name: 'management' })">
          <icon-svg name="shouye" class="site-sidebar__menu-icon"></icon-svg>
