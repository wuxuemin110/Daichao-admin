  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="110px">
      ...
      <el-form-item label="颜色编码" prop="color">
          <el-input v-model="dataForm.color" maxlength="30" placeholder="颜色编码"></el-input>
        </el-form-item>
      <el-form-item label="最小金额" prop="minAmount">
          <el-input v-model="dataForm.minAmount" maxlength="30" placeholder="最小金额"></el-input>
        </el-form-item>
      <el-form-item label="最大金额" prop="maxAmount">
          <el-input v-model="dataForm.maxAmount" maxlength="30" placeholder="最大金额"></el-input>

        </el-form-item><el-form-item label="最小天数" prop="minDays">
          <el-input v-model="dataForm.minDays" maxlength="30" placeholder="最小天数"></el-input>

        </el-form-item><el-form-item label="最大天数" prop="maxDays">
          <el-input v-model="dataForm.maxDays" maxlength="30" placeholder="最大天数"></el-input>
      ...
      <el-form-item label="成功年化率文本" prop="successRateTxt">
          <el-input v-model="dataForm.successRateTxt" maxlength="30" placeholder="成功年化率文本"></el-input>
        </el-form-item>


      <el-form-item label="标签" prop="label">
          <el-input v-model="dataForm.label" maxlength="30" placeholder="标签"></el-input>
        </el-form-item>
      ...
      <el-form-item label="推荐标签" prop="recommendTag">
          <el-input v-model="dataForm.recommendTag" maxlength="30" placeholder="推荐标签"></el-input>
        </el-form-item>
